...
function install_cfssl(){
	...
	mv $DIRNAME/cfssl_linux-amd64 $K8S_BIN_DIR/cfssl

	mv $DIRNAME/cfssljson_linux-amd64 $K8S_BIN_DIR/cfssljson

	mv $DIRNAME/cfssl-certinfo_linux-amd64 $K8S_BIN_DIR/cfssl-certinfo
